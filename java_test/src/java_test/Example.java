...
import java.util.*;
import java.text.*;
class TimerQuiz1 extends Thread{ //다중 상속이 안되서 TimerQuiz에 상속 시켯다.
	private Date date;
...
class Win7Quiz1 extends TimerQuiz1{
	private String[] name;
	private String[] info;
	public Win7Quiz1(String c,String m, String cPath,String mPath){
		name = new String[2];
		name[0]=c;name[1]=m;
		info = new String[2];
...
class Login1 extends Win7Quiz1{
    private String userId=null,userPw=null;
    public Login1(String c,String m,String cPath,String mPath){
...
class MyJframe extends TimerQuiz1{
	JFrame frame;
	Container c;
	JLabel label;
	Font font;
...
public static void main(String[] args){
    ...
    Login1 lo = new Login1("계산기","메모장","calc.exe","notepad.exe"); boolean flag=true;
    //lo.time();
    while(flag){
